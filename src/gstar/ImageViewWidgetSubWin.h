...
#ifndef GSTAR_IMAGE_VIEW_WIDGET_SUB_WIN_H
#define GSTAR_IMAGE_VIEW_WIDGET_SUB_WIN_H
...
public:
    ...
    */
   ImageViewWidgetSubWin(int rows = 1, int cols = 1, QWidget* parent = 0);

   /**
    * Destructor
    */
   virtual ~ImageViewWidgetSubWin();
