...
QString ScanRegionGraphicsItem::getUProbeName()
{
...
QRectF ScanRegionGraphicsItem::boundingRect() const
{
...
QRectF ScanRegionGraphicsItem::boundingRectMarker() const
{
...
void ScanRegionGraphicsItem::calculate()
{
...
AbstractGraphicsItem* ScanRegionGraphicsItem::duplicate()
{

   ScanRegionGraphicsItem* item = new ScanRegionGraphicsItem();
...
double ScanRegionGraphicsItem::getFactorX()
{
...
double ScanRegionGraphicsItem::getFactorY()
{
...
double ScanRegionGraphicsItem::getHeight()
{
...
double ScanRegionGraphicsItem::getWidth()
{
...
double ScanRegionGraphicsItem::getX()
{
...
double ScanRegionGraphicsItem::getY()
{
...
void ScanRegionGraphicsItem::hoverEnterEvent(QGraphicsSceneHoverEvent* event)
{
...
void ScanRegionGraphicsItem::hoverLeaveEvent(QGraphicsSceneHoverEvent* event)
{
...
void ScanRegionGraphicsItem::hoverMoveEvent(QGraphicsSceneHoverEvent* event)
{
...
void ScanRegionGraphicsItem::initialScale()
{
...
void ScanRegionGraphicsItem::mouseMoveEvent(QGraphicsSceneMouseEvent* event)
{
...
void ScanRegionGraphicsItem::zoomToRegion()
{
...
void ScanRegionGraphicsItem::mousePressEvent(QGraphicsSceneMouseEvent* event)
{
...
void ScanRegionGraphicsItem::mouseReleaseEvent(QGraphicsSceneMouseEvent* event)
{
...
void ScanRegionGraphicsItem::paint(QPainter* painter,
...
void ScanRegionGraphicsItem::setColor(const QColor& color)
{
...
void ScanRegionGraphicsItem::setGripSize()
{
...
void ScanRegionGraphicsItem::setHeight(double height)
{
...
void ScanRegionGraphicsItem::setMouseOverPixelCoordModel(CoordinateModel* model)
{
...
void ScanRegionGraphicsItem::setLightToMicroCoordModel(CoordinateModel* model)
{
...
void ScanRegionGraphicsItem::setSameRect(QRectF& rect)
{
...
void ScanRegionGraphicsItem::setSize(double size)
{
...
void ScanRegionGraphicsItem::setWidth(double width)
{
...
void ScanRegionGraphicsItem::setX(double x)
{
...
void ScanRegionGraphicsItem::setY(double y)
{
...
void ScanRegionGraphicsItem::updateModel()
{
...
void ScanRegionGraphicsItem::updateStringSize()
{
...
int ScanRegionGraphicsItem::predictFontPixelSizeByScale(qreal scale) {
...
void ScanRegionGraphicsItem::updateView()
{
